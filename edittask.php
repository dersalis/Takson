...
<?php 
    ...
    if(isset($_POST['okTask'])) {
        ...
        if($name && $priority && $author) {
            update($taskId, $name, $description, $priority, $author, $assigned);
        }
    }
?>
<!doctype html>
    ...
    <div class="container">
        ...
        <form class="mt-4 col-6" method="post">
            <div class="mb-3">
                ...
                <input name="name" value="<?php echo $name ?>" type="text" class="form-control" id="name" aria-describedby="nameHelp">
                <?php 
                    // if(!$isNameCorrect) {
            ...
            <div class="mb-3">
                ...
                <input name="description" value="<?php echo $description ?>" type="text" class="form-control" id="description" aria-describedby="descriptionHelp">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input name="author" value="<?php echo $author ?>" type="text" class="form-control" id="author" aria-describedby="authorHelp">
            ...
            <div class="mb-4">
                ...
                <input name="assigned" value="<?php echo $assigned ?>" type="text" class="form-control" id="assigned" aria-describedby="assignedHelp">
            </div>

            <div>
                <button name="cancelDelete" type="submit" class="btn btn-primary">Cancel</button>
                <button name="okTask" type="submit" class="btn btn-success">Ok</button>
            </div>
        </form>
